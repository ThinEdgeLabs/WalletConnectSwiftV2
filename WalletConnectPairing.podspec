...
Pod::Spec.new do |spec|
  ...
  spec.name         = "WalletConnectPairing"
  spec.version      = "0.0.1"
  spec.summary      = "WalletConnectV2Swift - WalletConnectPairing"
  ...
  spec.author             = { "ThinEdgeLabs" => "admin@thinedgelabs.org" }
  ...
  spec.source_files  = "Sources/WalletConnectPairing"
  ...
  spec.dependency "WalletConnectNetworking"
  spec.dependency "JSONRPC"
